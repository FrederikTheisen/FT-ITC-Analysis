...
public sealed class ViewerUploadTests : IClassFixture<WebApplicationFactory<Program>>
{
    ...
    public async Task ViewerShellUsesListsAndExclusiveProcessingModes()
    {
        ...
        Assert.Equal("2026.09.10-comprehensive-preset.1", page.Headers.GetValues("X-FTITC-Viewer-Build").Single());
        ...
        Assert.Contains("2026.09.10-guidance-3.2.2", html);
        Assert.Contains("app.js?v=2026.09.10-guidance-3.2.2", html);
        Assert.Contains("viewer-charts-2.35.3.min.js?v=2026.09.10-guidance-3.2.2", html);
        ...
        Assert.Contains("const viewerBuild = \"2026.09.10-guidance-3.2.2\"", script);
