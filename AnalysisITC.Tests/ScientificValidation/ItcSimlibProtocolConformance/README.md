# itcsimlib protocol-conformance pilot
...
bookkeeping does not match FT-ITC's documented MicroCal convention.
...
The associated Core test checks forward-predicted integrated heats at the
