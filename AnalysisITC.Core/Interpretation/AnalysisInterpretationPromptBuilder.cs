...
namespace AnalysisITC.Core.Interpretation
{
    ...
    public static class AnalysisInterpretationPromptBuilder
    {
        ...
        public static string BuildResponseFormatInstructions(AnalysisInterpretationPackage package = null) =>
            ...
            "Omit optional sections that do not add useful interpretation. Prefer around 300-400 words or fewer; use up to roughly 1,000 words when the evidence and analysis depth warrants more detail. Treat these as flexible limits including references, not hard limits.\n" +
