...
namespace AnalysisITC.Core.Analysis.Models
{
    public class TwoCompetingSites : Model
    {
        ...
        public override void InitializeParameters(ExperimentData data)
        {
            ...
            Parameters.AddOrUpdateParameter(ParameterType.Affinity1, PreviousOrDefault(ParameterType.Affinity1, 100*this.GuessLogAffinity()));
            Parameters.AddOrUpdateParameter(ParameterType.Enthalpy2, PreviousOrDefault(ParameterType.Enthalpy2, 0.1*this.GuessEnthalpy()));
            Parameters.AddOrUpdateParameter(ParameterType.Affinity2, PreviousOrDefault(ParameterType.Affinity2, this.GuessLogAffinity()));
        ...
        {
            Model mdl = new TwoCompetingSites(Data.GetSynthClone(ModelCloneOptions, random));
        ...
        public class ModelSolution : SolutionInterface
        {
            ...
            public override void ComputeErrorsFromBootstrapSolutions()
            {
                ...
                Parameters[ParameterType.Affinity1] = SummarizeBootstrapDistribution(k1, K1);
                ...
                Parameters[ParameterType.Affinity2] = SummarizeBootstrapDistribution(k2, K2);
            ...
            public override List<Tuple<string, string>> UISolutionParameters(FinalFigureDisplayParameters info)
            {
                ...
                //if (info.HasFlag(FinalFigureDisplayParameters.TdS)) output.Add(new(MarkdownStrings.EntropyContribution, TdS.ToFormattedString(ReportEnergyUnit, permole: true))); // Perhaps TMI
