...
namespace AnalysisITC.Core.Analysis.Models
{
    public class OneSetOfSitesSyringeUncertainty : Model
	{
        ...
        {
			Model mdl = new OneSetOfSitesSyringeUncertainty(Data.GetSynthClone(ModelCloneOptions, random));
        ...
        public class ModelSolution : SolutionInterface
        {
            ...
            public override void ComputeErrorsFromBootstrapSolutions()
            {
                ...
                Parameters[ParameterType.Affinity1] = SummarizeBootstrapDistribution(k, K);
