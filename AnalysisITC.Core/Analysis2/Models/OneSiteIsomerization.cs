...
namespace AnalysisITC.Core.Analysis.Models
{
    public class OneSiteIsomerization : Model
    {
        ...
        {
            Model mdl = new OneSiteIsomerization(Data.GetSynthClone(ModelCloneOptions, random));
            ...
            mdl.ModelOptions[AttributeKey.Percentage].ParameterValue =
                new FloatWithError(FWEMath.Clamp(ModelOptions[AttributeKey.Percentage].ParameterValue.Sample(random), limits[0], limits[1]), 0);
        ...
        public class ModelSolution : SolutionInterface
        {
            ...
            public override void ComputeErrorsFromBootstrapSolutions()
            {
                ...
                Parameters[ParameterType.Affinity1] = SummarizeBootstrapDistribution(k, K_app);
