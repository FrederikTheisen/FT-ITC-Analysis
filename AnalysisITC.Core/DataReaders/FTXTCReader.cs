...
namespace AnalysisITC.Core.DataReaders
{
    ...
    public static class FTXTCReader
    {
        ...
        static SolverConvergence RestoreConvergence(FtxtcConvergenceState value) => value == null ? null : SolverConvergence.FromSnapshot(new SolverConvergenceSnapshot
        {
            ...
            Iterations = value.Iterations, Loss = value.Loss, Objective = value.Objective, TimeSeconds = value.TimeSeconds,
        ...
        static ExperimentDateSource ParseDateSource(string value) => value switch { null => ExperimentDateSource.Unknown, "data-file" => ExperimentDateSource.DataFile, "file-system" => ExperimentDateSource.FileSystem, "user-modified" => ExperimentDateSource.UserModified, _ => throw new NotSupportedException() };
