...
namespace AnalysisITC.Core.DataReaders
{
    ...
    public static class FTXTCReader
    {
        ...
        static ITCDataFormat ParseDataFormat(string value) => value switch { "microcal-itc200" => ITCDataFormat.ITC200, "ftitc" => ITCDataFormat.FTITC, "ftxtc" => ITCDataFormat.FTXTC, "ta-itc" => ITCDataFormat.TAITC, "integrated-heats" => ITCDataFormat.IntegratedHeats, "peaq-itc-project" => ITCDataFormat.PEAQITCProject, "origin-opj" => ITCDataFormat.OriginProject, "unknown" => ITCDataFormat.Unknown, _ => throw new NotSupportedException($"Unknown data format '{value}'.") };
        static ITCInstrument ParseInstrument(string value) => value switch { "unknown" => ITCInstrument.Unknown, "microcal-itc200" => ITCInstrument.MicroCalITC200, "microcal-peaq-itc" => ITCInstrument.MalvernITC200, "ta-itc-standard" => ITCInstrument.TAInstrumentsITCStandard, "ta-itc-low-volume" => ITCInstrument.TAInstrumentsITCLowVolume, _ => throw new NotSupportedException($"Unknown instrument '{value}'.") };
