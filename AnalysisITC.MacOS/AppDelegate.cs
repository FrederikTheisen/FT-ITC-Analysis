...
namespace AnalysisITC
{
    ...
    public partial class AppDelegate : NSApplicationDelegate
    {
        ...
        public override bool OpenFile(NSApplication sender, string filename)
        {
            ...
            AnalysisITC.UI.MacOS.MacDataReader.Read(url);
        ...
        private void AppDelegate_OpenFileDialog(object sender, EventArgs e)
        {
            ...
            {
                AnalysisITC.UI.MacOS.MacDataReader.Read(FileDialog.Urls);
            }
        ...
        partial void OpenInterpretationRegistration(NSObject sender)
        {
