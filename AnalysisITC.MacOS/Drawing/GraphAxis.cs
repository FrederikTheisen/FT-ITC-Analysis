...
namespace AnalysisITC.UI.MacOS.Drawing
{
    public class GraphAxis
    {
        ...
        void DrawAxisTitle(CGContext gc)
        {
            ...
            var atttitle = AnalysisITC.UI.MacOS.MacStrings.FromMarkDownString(LegendTitle, NSFont.FromCTFont(TitleFont), true);
        ...
        public nfloat EstimateLabelMargin()
        {
            ...
            var titlesize = HideTitle || string.IsNullOrEmpty(LegendTitle)
                ? new CGSize(0, 0)
                : CGGraph.MeasureString(AnalysisITC.UI.MacOS.MacStrings.FromMarkDownString(LegendTitle, NSFont.FromCTFont(TitleFont), true), Position, false);
