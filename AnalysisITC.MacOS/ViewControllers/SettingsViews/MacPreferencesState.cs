...
namespace AnalysisITC
{
    sealed class MacPreferencesState
    {
        ...
        public ColorSchemeGradientMode ColorSchemeGradientMode { get; set; }
        ...
        public static MacPreferencesState FromSettings() => new MacPreferencesState
        {
            ...
            FinalFigureHeightCentimeters = AppSettings.FinalFigureDimensions.Length > 1 ? AppSettings.FinalFigureDimensions[1] : 10,
        ...
        public static MacPreferencesState Defaults() => new MacPreferencesState
        {
            ...
            FinalFigureHeightCentimeters = 10,
        ...
        public void Apply()
        {
            ...
            AppSettings.EnableExtendedParameterLimits = ParameterLimitSetting != ParameterLimitSetting.Standard;
