...
namespace AnalysisITC
{
    public partial class AnalysisResultTabViewController : NSViewController
    {
        ...
        public override void ViewDidLoad()
        {
            ...
            ElectroResultDescField.AttributedStringValue = AnalysisITC.UI.MacOS.MacStrings.FromMarkDownString(string.Join(Environment.NewLine, new List<string>()
            {
                MarkdownStrings.DissociationConstant + " extrapolated to zero salt:",
                "Counterion-release slope:",
            }), NSFont.SystemFontOfSize(11));

            ProtonationAnalysisResultDescriptionField.AttributedStringValue = AnalysisITC.UI.MacOS.MacStrings.FromMarkDownString(string.Join(Environment.NewLine, new List<string>()
            {
        ...
        public void SetupResultView()
        {
            ...
            ResultEvalTempUnitLabel.StringValue = UseKelvin ? "K" : "°C";

            // Solution and Solver Information Area
            SetupSolutionInformation();

            /// Setup the description lines for the result view
            SetupEvalValueDescriptionLabels();

            /// Populate Table View
            PopulateTable();

            /// Options and Constraints Information
        ...
        void RefreshScrollHintFade()
        {
            void refreshIfVisible()
            {
                ...
                if (ScrollView is UI.MacOS.CustomViews.FadingScrollView fadingScrollView)
        ...
        private void SetupEvalValueDescriptionLabels()
        {
            ...
            if (AnalysisResult.IsTemperatureDependenceEnabled)
            {
                ...
                else eval_parameters.Add($"Heat capacity change ({MarkdownStrings.HeatCapacityChange})");
            }
            ...
            EvalResultDescField.AttributedStringValue = AnalysisITC.UI.MacOS.MacStrings.FromMarkDownString(string.Join(Environment.NewLine, eval_parameters), NSFont.SystemFontOfSize(11));
        }
        ...
        void SetConstraintsAndOptions()
        {
            ...
            TempDependenceResultDescField.AttributedStringValue = AnalysisITC.UI.MacOS.MacStrings.FromMarkDownString(string.Join(Environment.NewLine, items.Select(i => i.Item1)), NSFont.SystemFontOfSize(NSFont.SmallSystemFontSize));
