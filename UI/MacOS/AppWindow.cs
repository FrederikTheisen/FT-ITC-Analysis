	...
	public partial class AppWindow : NSWindow, INSDraggingDestination
    {
        ...
        public bool PerformDragOperation(NSDraggingInfo sender)
        {
            ...
            if (nsurls != null)
            {
                ...
                AnalysisITC.UI.MacOS.MacDataReader.Read(urls);
        ...
        public NSDragOperation DraggingEntered(NSDraggingInfo sender)
        {
            ...
            if (fileUrls != null)
            {
                foreach (NSString fileUrl in fileUrls)
                {
                    ...
                    var format = AnalysisITC.Core.DataReaders.DataReader.GetFormat(path);

                    if (format != AnalysisITC.Core.DataReaders.ITCDataFormat.Unknown)
                    {
                        readableFiles++;
                        canBeDropped = true;
                    }
