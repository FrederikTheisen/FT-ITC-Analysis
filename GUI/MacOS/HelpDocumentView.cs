...
namespace AnalysisITC
{
    class HelpDocumentView
    {
        ...
        void RenderText(string text)
        {
            ...
            var processedText = Utilities.MarkdownProcessor.ProcessWrittenText(paddedText);
            var attributedString = Utilities.MacStrings.FromMarkDownString(processedText, font);
        ...
        class HelpTopic : NSObject
        {
            ...
            {
                var processedTitle = Utilities.MarkdownProcessor.ProcessWrittenText(Title);
                return Utilities.MacStrings.FromMarkDownString(processedTitle, font).Value;
            }
        }
