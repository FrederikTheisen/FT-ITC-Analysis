...
public sealed class InterpretationUsageStore
{
    ...
    void EnsureInitialized()
    {
        ...
        lock (initializeLock)
        {
            ...
            using var command = connection.CreateCommand(); command.CommandText = Schema; command.ExecuteNonQuery(); initialized = true;
        }
    }
