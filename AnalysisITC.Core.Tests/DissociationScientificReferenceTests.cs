...
namespace AnalysisITC.Core.Tests
{
    ...
    public sealed class DissociationScientificReferenceTests : IDisposable
    {
        ...
        // Frozen independent references: post-concentrations use the written
        // MicroCal approximation at nominal cumulative volumes, then molar heats
        // use the analytic monomer-dimer equilibrium and reaction enthalpy. The
        // arrays are not generated by RawDataReader or the production model.
        static readonly double[] MicroCalHeatsJoules =
        {
            2.745494495351515e-06, 2.442371099396948e-05,
            2.069292452626013e-05, 1.832644465936897e-05,
            1.665425076972109e-05, 1.53925000407731e-05,
            1.439725865184505e-05, 1.358664987925954e-05,
            1.291018780063181e-05, 1.233481833118665e-05,
            1.183787073336321e-05, 1.14032075311953e-05,
        };
        ...
        {
            2.14266581632653e-07, 2.354827806122449e-06,
            4.4915625e-06, 6.624470663265306e-06,
            8.753552295918367e-06, 1.087880739795918e-05,
            1.300023596938775e-05, 1.511783801020408e-05,
            1.723161352040816e-05, 1.93415625e-05,
            2.144768494897959e-05, 2.354998086734694e-05,
        };
