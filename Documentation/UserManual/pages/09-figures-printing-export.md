...
The collection-capable client requires the matching FT-ITC interpretation service using relay contract 3.0. There is no compatibility adapter or version negotiation; update the app and MIST service together. Local report editing, saved interpretations and PDF export remain available if generation is unavailable.
